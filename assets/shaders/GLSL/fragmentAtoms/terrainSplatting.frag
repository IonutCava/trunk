...
vec4 getFinalColor1(const in vec4 blendMap, const in int index, const in vec4 diffSize) {
    return texture(texTileMaps[index], vec3(_texCoord * diffSize.r, 0)) * blendMap.r;
}

vec3 getFinalTBN1(const in vec4 blendMap, const in int index, const in vec4 normSize){
    return texture(texTileMaps[index], vec3(_texCoord * normSize.r, 1)).rgb * blendMap.r;
}

vec4 getFinalColor2(const in vec4 blendMap, const in int index, const in vec4 diffSize){
...
vec3 getFinalTBN2(const in vec4 blendMap, const in int index, const in vec4 normSize){
...
vec4 getFinalColor3(const in vec4 blendMap, const in int index, const in vec4 diffSize){
...
vec3 getFinalTBN3(const in vec4 blendMap, const in int index, const in vec4 normSize){
...
vec4 getFinalColor4(const in vec4 blendMap, const in int index, const in vec4 diffSize){
...
vec3 getFinalTBN4(const in vec4 blendMap, const in int index, const in vec4 normSize){
