...
void main(void)
{
    ...
    rcpFrame.x = dvd_invScreenDimensions.x;
    rcpFrame.y = dvd_invScreenDimensions.y;

    vec2 pos;
    pos.xy = gl_FragCoord.xy / dvd_ViewPort.zw;
    ...
    _colorOut = FxaaPixelShader(pos, ConsolePosPos, texScreen, texScreen, texScreen, rcpFrame, ConsoleRcpFrameOpt, ConsoleRcpFrameOpt2, Console360RcpFrameOpt2, QualitySubpix, QualityEdgeThreshold, QualityEdgeThresholdMin, ConsoleEdgeSharpness, ConsoleEdgeThreshold, ConsoleEdgeThresholdMin, Console360ConstDir);
}