...
namespace gameswf
{
	...
	struct text_glyph_record
	{
		...
		text_style	m_style;
		SWF::array<glyph_entry>	m_glyphs;
	...
	static void	display_glyph_records(
		...
		character* inst,
		const SWF::array<text_glyph_record>& records,
		movie_definition_sub* root_def)
	{
		static SWF::array<fill_style>	s_dummy_style;	// used to pass a color on to shape_character::display()
		static SWF::array<line_style>	s_dummy_line_style;
...
//		matrix	base_matrix = sub_di.m_matrix;
	...
	struct text_character_def : public character_def
	{
		...
		rect	m_rect;
		matrix	m_matrix;
		SWF::array<text_glyph_record>	m_text_glyph_records;
...
// 					// else { Don't mask the top bit; the first record is allowed to have > 127 glyphs. }
	...
	struct edit_text_character : public character
	{
		...
		SWF::array<text_glyph_record>	m_text_glyph_records;
		SWF::array<fill_style>	m_dummy_style;	// used to pass a color on to shape_character::display()
		SWF::array<line_style>	m_dummy_line_style;
