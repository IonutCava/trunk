...
public:
	...
	protected:
		friend class SWF::hash<T,U,hash_functor>;
...
template<class U>
class string_hash : public SWF::hash<tu_string, U, string_hash_functor<tu_string> >
{
};
...
template<class U>
class stringi_hash : public SWF::hash<tu_stringi, U, stringi_hash_functor<tu_stringi> >
{
};
