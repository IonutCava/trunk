...
namespace gameswf
{
	...
	private:
		...
		SWF::array< smart_ptr<shape_character_def> >	m_glyphs;
		SWF::array< texture_glyph >	m_texture_glyphs;	// cached info, built by gameswf_fontlib.
		...
		SWF::hash<Uint16, int, simple_code_hash<Uint16> > m_code_table;

		// Layout stuff.
		float	m_ascent;
		float	m_descent;
		float	m_leading;
		SWF::array<float>	m_advance_table;
		...
		SWF::hash<kerning_pair, float>	m_kerning_pairs;
	};
