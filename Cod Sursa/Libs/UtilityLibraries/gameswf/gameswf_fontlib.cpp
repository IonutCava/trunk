...
namespace fontlib
{
	SWF::array< smart_ptr<font> >	s_fonts;
...
// gameswf::fontlib::set_nominal_glyph_pixel_size()
	...
	static SWF::array< pending_glyph_info >	s_pending_glyphs;
	...
	static SWF::array<recti>	s_covered_rects;
	...
	static SWF::array<pointi>	s_anchor_points;
	...
	bool	try_to_reuse_previous_image(
		...
		const SWF::hash<unsigned int, const rendered_glyph_info*>& image_hash)
	...
	void	pack_and_assign_glyphs(SWF::array<rendered_glyph_info>* glyph_info, movie_definition_sub* owner)
	...
	// otherwise doesn't munge the array.
	{
		...
		SWF::hash<unsigned int, const rendered_glyph_info*>	image_hash;
	...
	static void	generate_font_bitmaps(SWF::array<rendered_glyph_info>* glyph_info, font* f, movie_definition_sub* owner)
	...
	static void	wipe_font_textures(const SWF::array<font*>& fonts)
	{
	...
	void	generate_font_bitmaps(const SWF::array<font*>& fonts, movie_definition_sub* owner)
	// Build cached textures from glyph outlines.
	{
		...
		SWF::array<rendered_glyph_info>	glyph_info;
	...
	void	input_cached_data(tu_file* in, const SWF::array<font*>& fonts, movie_definition_sub* owner)
