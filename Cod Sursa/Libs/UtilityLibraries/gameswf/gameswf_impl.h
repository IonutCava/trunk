...
namespace gameswf
{
	...
	{
		virtual const SWF::array<execute_tag*>&	get_playlist(int frame_number) = 0;
		virtual const SWF::array<execute_tag*>*	get_init_actions(int frame_number) = 0;
...
//v for extern movies
	...
	struct character : public movie
	{
		...
		float	m_ratio;
                Uint16 	m_clip_depth;
		bool	m_visible;
		SWF::hash<event_id, as_value>	m_event_handlers;
