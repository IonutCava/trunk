...
void NavMeshDebugDraw::begin(duDebugDrawPrimitives prim, F32 size) {
    ...
    _primitive->attribute4f(to_const_U32(AttribLocation::VERTEX_COLOR), vec4<F32>(1.0f, 1.0f, 1.0f, 0.5f));
...
void NavMeshDebugDraw::vertex(const F32 x, const F32 y, const F32 z,
    ...
    _primitive->attribute4f(to_const_U32(AttribLocation::VERTEX_COLOR), Util::ToFloatColour(colourVec));
