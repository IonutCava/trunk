...
#endif
#endif
GLUTAPI void APIENTRY glutInitDisplayMode(U32 mode);
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
...
GLUTAPI void APIENTRY glutTimerFunc(U32 millis, void (GLUTCALLBACK *func)(int value), int value);
...
GLUTAPI void APIENTRY glutJoystickFunc(void (GLUTCALLBACK *func)(U32 buttonMask, int x, int y, int z), int pollInterval);
#endif
#endif
#endif
