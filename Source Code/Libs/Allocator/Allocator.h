...
#define DECLARE_ALLOCATOR \
    public: \
        ...
        void operator delete(void* pObject, const char* zFile, size_t nLine) { \
            _allocator.Deallocate(pObject); \
        } \
    private: \
