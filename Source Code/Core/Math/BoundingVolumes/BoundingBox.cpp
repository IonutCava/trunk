...
namespace Divide {
BoundingBox::BoundingBox() : GUIDWrapper(),
                            _computed(false),
                            _pointsDirty(true)
{
...
BoundingBox::BoundingBox(const vec3<F32>& min, const vec3<F32>& max) : GUIDWrapper(),
                                                                       _computed(false),
                                                                       _pointsDirty(true),
                                                                       _min(min),
                                                                       _max(max)
...
bool BoundingBox::Transform(const BoundingBox& initialBoundingBox, const mat4<F32>& mat, bool force) {
