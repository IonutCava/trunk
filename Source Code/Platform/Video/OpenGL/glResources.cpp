...
void fillEnumTables() {
    ...
    glShaderStageTable[to_uint(ShaderType::TESSELATION_CTRL)] = GL_TESS_CONTROL_SHADER;
    glShaderStageTable[to_uint(ShaderType::TESSELATION_EVAL)] = GL_TESS_EVALUATION_SHADER;
    ...
    glShaderStageNameTable[to_uint(ShaderType::TESSELATION_CTRL)] = "TessellationC";
    glShaderStageNameTable[to_uint(ShaderType::TESSELATION_EVAL)] = "TessellationE";
