...
glSamplerObject::glSamplerObject(const SamplerDescriptor& descriptor)
{
    ...
    glSamplerParameteri(_samplerID, GL_TEXTURE_MIN_FILTER, GLUtil::GL_ENUM_TABLE::glTextureFilterTable[descriptor.minFilter()]);
    glSamplerParameteri(_samplerID, GL_TEXTURE_MAG_FILTER, GLUtil::GL_ENUM_TABLE::glTextureFilterTable[descriptor.magFilter()]);
    glSamplerParameteri(_samplerID, GL_TEXTURE_WRAP_S, GLUtil::GL_ENUM_TABLE::glWrapTable[descriptor.wrapU()]);
    glSamplerParameteri(_samplerID, GL_TEXTURE_WRAP_T, GLUtil::GL_ENUM_TABLE::glWrapTable[descriptor.wrapV()]);
    glSamplerParameteri(_samplerID, GL_TEXTURE_WRAP_R, GLUtil::GL_ENUM_TABLE::glWrapTable[descriptor.wrapW()]);
    ...
    if(descriptor._useRefCompare){
        ...
        glSamplerParameteri(_samplerID, GL_TEXTURE_COMPARE_FUNC,  GLUtil::GL_ENUM_TABLE::glCompareFuncTable[descriptor._cmpFunc]);
    }
