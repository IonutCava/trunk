...
Frustum::FrustCollision Frustum::ContainsBoundingBox(const BoundingBox& bbox) const {
    ...
    for (const Plane<F32>& frustumPlane : _frustumPlanes){
        ...
        if(iInCount == 0) return FRUSTUM_OUT;
        iTotalIn += iPtIn;
    }
...
void Frustum::Extract(){
    ...
    rightPlane.set( mat[3] - mat[0], mat[7] - mat[4], mat[11] - mat[ 8], mat[15] - mat[12]); rightPlane.normalize();
    leftPlane.set(  mat[3] + mat[0], mat[7] + mat[4], mat[11] + mat[ 8], mat[15] + mat[12]); leftPlane.normalize();
    bottomPlane.set(mat[3] + mat[1], mat[7] + mat[5], mat[11] + mat[ 9], mat[15] + mat[13]); bottomPlane.normalize();
    topPlane.set(   mat[3] - mat[1], mat[7] - mat[5], mat[11] - mat[ 9], mat[15] - mat[13]); topPlane.normalize();
    farPlane.set(   mat[3] - mat[2], mat[7] - mat[6], mat[11] - mat[10], mat[15] - mat[14]); farPlane.normalize();
    nearPlane.set(  mat[3] + mat[2], mat[7] + mat[6], mat[11] + mat[10], mat[15] + mat[14]); nearPlane.normalize();
