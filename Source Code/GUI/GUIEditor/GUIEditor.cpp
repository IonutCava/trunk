...
void GUIEditor::TrackSelection() {
    if (_currentSelection && !_pauseSelectionTracking) {
        ...
        _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_X] =
            localOrientation.x;
        ...
        _toggleButtons[TOGGLE_SHADOW_MAPPING]->setSelected(
            rComp->castsShadows());
        _toggleButtons[TOGGLE_WIREFRAME]->setSelected(rComp->renderWireframe());
        _toggleButtons[TOGGLE_BOUNDING_BOXES]->setSelected(
...
void GUIEditor::UpdateControls() {
    ...
    if (_currentSelection) {
        ...
        _toggleButtons[TOGGLE_SHADOW_MAPPING]->setEnabled(
    ...
    _toggleButtons[TOGGLE_POST_FX]->setSelected(
        GFX_DEVICE.postProcessingEnabled());
    _toggleButtons[TOGGLE_FOG]->setSelected(
        ParamHandler::getInstance().getParam<bool>("rendering.enableFog",
                                                   false));
...
bool GUIEditor::update(const U64 deltaTime) {
    ...
    if (_createNavMeshQueued) {
        ...
        AI::AIManager::getInstance().toggleNavMeshDebugDraw(
            _toggleButtons[TOGGLE_NAV_MESH_DRAW]->isSelected());
        ...
        if (!loaded) {
            ...
            loaded = temp->build(
                nullptr, AI::Navigation::NavigationMesh::CreationCallback(),
                false);
...
void GUIEditor::RegisterHandlers() {
    ...
    {
        _toggleButtons[TOGGLE_WIREFRAME] = static_cast<CEGUI::ToggleButton *>(
            EditorBar->getChild("ToggleWireframe"));
        toggleButton = _toggleButtons[TOGGLE_WIREFRAME];
        toggleButton->subscribeEvent(
    ...
    {
        _toggleButtons[TOGGLE_DEPTH_PREVIEW] =
    ...
    // Toggle Shadows
    {
        _toggleButtons[TOGGLE_SHADOW_MAPPING] =
            static_cast<CEGUI::ToggleButton *>(
    ...
    // Toggle Fog
    {
        _toggleButtons[TOGGLE_FOG] = static_cast<CEGUI::ToggleButton *>(
    ...
    // Toggle PostFX
    {
        _toggleButtons[TOGGLE_POST_FX] = static_cast<CEGUI::ToggleButton *>(
    ...
    {
        _toggleButtons[TOGGLE_BOUNDING_BOXES] =
            static_cast<CEGUI::ToggleButton *>(
    ...
    {
        _toggleButtons[TOGGLE_NAV_MESH_DRAW] =
            static_cast<CEGUI::ToggleButton *>(
    ...
    {
        _toggleButtons[TOGGLE_SKELETONS] = static_cast<CEGUI::ToggleButton *>(
    ...
    // Type new X Position
    {
        _valuesField[TRANSFORM_POSITION][CONTROL_FIELD_X] =
    ...
    // Type new Y Position
    {
        _valuesField[TRANSFORM_POSITION][CONTROL_FIELD_Y] =
            static_cast<CEGUI::Editbox *>(
    ...
    // Type new Z Position
    {
        _valuesField[TRANSFORM_POSITION][CONTROL_FIELD_Z] =
            static_cast<CEGUI::Editbox *>(
    ...
    // Type new Position Granularity
    {
        ...
        field->setText(CEGUI::PropertyHelper<F32>::toString(
            _currentValues[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY]));
        field->setValidationString(
            CEGUI::String("^[-+]?[0-9]{1,10}([.][0-9]{1,10})?$"));
    }
    // Type new X Rotation
    {
        _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_X] =
            static_cast<CEGUI::Editbox *>(
    ...
    // Type new Y Rotation
    {
        _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_Y] =
            static_cast<CEGUI::Editbox *>(
    ...
    // Type new Z Rotation
    {
        _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_Z] =
            static_cast<CEGUI::Editbox *>(
    ...
    // Type new Rotation Granularity
    {
        ...
        field->setText(CEGUI::PropertyHelper<F32>::toString(
            _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY]));
        field->setValidationString(
            CEGUI::String("^[-+]?[0-9]{1,10}([.][0-9]{1,10})?$"));
    }
    // Type new X Scale
    {
        _valuesField[TRANSFORM_SCALE][CONTROL_FIELD_X] =
    ...
    // Type new Y Scale
    {
        _valuesField[TRANSFORM_SCALE][CONTROL_FIELD_Y] =
    ...
    // Type new Z Scale
    {
        _valuesField[TRANSFORM_SCALE][CONTROL_FIELD_Z] =
    ...
    // Type new Scale Granularity
    {
        ...
        field->subscribeEvent(
            ...
            CEGUI::Event::Subscriber(&GUIEditor::Handle_ScaleGranularityChange,
                                     this));
        field->setText(CEGUI::PropertyHelper<F32>::toString(
            _currentValues[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY]));
        field->setValidationString(
            CEGUI::String("^[-+]?[0-9]{1,10}([.][0-9]{1,10})?$"));
    }
    ...
    {
        _transformButtonsInc[TRANSFORM_POSITION][CONTROL_FIELD_X] =
    ...
    {
        _transformButtonsDec[TRANSFORM_POSITION][CONTROL_FIELD_X] =
    ...
    {
        _transformButtonsInc[TRANSFORM_POSITION][CONTROL_FIELD_Y] =
    ...
    {
        _transformButtonsDec[TRANSFORM_POSITION][CONTROL_FIELD_Y] =
    ...
    {
        _transformButtonsInc[TRANSFORM_POSITION][CONTROL_FIELD_Z] =
    ...
    {
        _transformButtonsDec[TRANSFORM_POSITION][CONTROL_FIELD_Z] =
    ...
    {
        _transformButtonsInc[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY] =
    ...
    {
        _transformButtonsDec[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY] =
    ...
    {
        _transformButtonsInc[TRANSFORM_ROTATION][CONTROL_FIELD_X] =
    ...
    {
        _transformButtonsDec[TRANSFORM_ROTATION][CONTROL_FIELD_X] =
    ...
    {
        _transformButtonsInc[TRANSFORM_ROTATION][CONTROL_FIELD_Y] =
    ...
    {
        _transformButtonsDec[TRANSFORM_ROTATION][CONTROL_FIELD_Y] =
    ...
    {
        _transformButtonsInc[TRANSFORM_ROTATION][CONTROL_FIELD_Z] =
    ...
    {
        _transformButtonsDec[TRANSFORM_ROTATION][CONTROL_FIELD_Z] =
    ...
    {
        _transformButtonsInc[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY] =
    ...
    // Decrement X Scale
    {
        _transformButtonsDec[TRANSFORM_SCALE][CONTROL_FIELD_X] =
    ...
    // Increment Y Scale
    {
        _transformButtonsInc[TRANSFORM_SCALE][CONTROL_FIELD_Y] =
    ...
    // Decrement Y Scale
    {
        _transformButtonsDec[TRANSFORM_SCALE][CONTROL_FIELD_Y] =
    ...
    // Increment Z Scale
    {
        _transformButtonsInc[TRANSFORM_SCALE][CONTROL_FIELD_Z] =
    ...
    // Decrement Z Scale
    {
        _transformButtonsDec[TRANSFORM_SCALE][CONTROL_FIELD_Z] =
    ...
    {
        _transformButtonsInc[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY] =
    ...
    {
        _transformButtonsDec[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY] =
...
bool GUIEditor::Handle_WireframeToggle(const CEGUI::EventArgs &e) {
    ...
    if (_currentSelection) {
        _currentSelection->getComponent<RenderingComponent>()->renderWireframe(
            _toggleButtons[TOGGLE_WIREFRAME]->isSelected());
    }
    return true;
}
...
bool GUIEditor::Handle_ShadowMappingToggle(const CEGUI::EventArgs &e) {
    ...
    if (_currentSelection) {
        _currentSelection->getComponent<RenderingComponent>()->castsShadows(
            _toggleButtons[TOGGLE_SHADOW_MAPPING]->isSelected());
    }
    return true;
}
...
bool GUIEditor::Handle_FogToggle(const CEGUI::EventArgs &e) {
    ...
    ParamHandler::getInstance().setParam(
        "rendering.enableFog", _toggleButtons[TOGGLE_FOG]->isSelected());
...
bool GUIEditor::Handle_PostFXToggle(const CEGUI::EventArgs &e) {
    ...
    GFX_DEVICE.postProcessingEnabled(
        _toggleButtons[TOGGLE_POST_FX]->isSelected());
    return true;
}
...
bool GUIEditor::Handle_BoundingBoxesToggle(const CEGUI::EventArgs &e) {
    ...
    if (_currentSelection) {
        RenderingComponent *rComp =
            _currentSelection->getComponent<RenderingComponent>();
        rComp->renderBoundingBox(
            _toggleButtons[TOGGLE_BOUNDING_BOXES]->isSelected());
    }
    return true;
}
...
bool GUIEditor::Handle_SkeletonsToggle(const CEGUI::EventArgs &e) {
    ...
    if (_currentSelection) {
        _currentSelection->getComponent<RenderingComponent>()->renderSkeleton(
            _toggleButtons[TOGGLE_SKELETONS]->isSelected());
    }
    return true;
}
...
bool GUIEditor::Handle_PositionGranularityChange(const CEGUI::EventArgs &e) {
    ...
    F32 gran = CEGUI::PropertyHelper<F32>::fromString(
        _valuesField[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY]->getText());
    _currentValues[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY] = gran;
    CLAMP<F32>(_currentValues[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY],
               0.0000001f, 10000000.0f);
    CEGUI::String granStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY]);
    _valuesField[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY]->setText(
        granStr);
    return true;
}
...
bool GUIEditor::Handle_RotationXChange(const CEGUI::EventArgs &e) {
    ...
    F32 x = CEGUI::PropertyHelper<F32>::fromString(
        _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_X]->getText());
    _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_X] = x;
    CLAMP<F32>(_currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_X], -360.0f,
               360.0f);
    CEGUI::String xStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_X]);
    _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_X]->setText(xStr);
    PhysicsComponent *pComp =
        _currentSelection->getComponent<PhysicsComponent>();
    pComp->setRotation(
        vec3<F32>(_currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_X],
                  _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Y],
                  _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Z]));
    _pauseSelectionTracking = false;
    return true;
...
bool GUIEditor::Handle_RotationYChange(const CEGUI::EventArgs &e) {
    ...
    F32 y = CEGUI::PropertyHelper<F32>::fromString(
        _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_Y]->getText());
    _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Y] = y;
    CLAMP<F32>(_currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Y], -360.0f,
               360.0f);
    CEGUI::String yStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Y]);
...
bool GUIEditor::Handle_RotationZChange(const CEGUI::EventArgs &e) {
    Console::d_printfn("[Editor]: Position X changed via text edit!");
    F32 z = CEGUI::PropertyHelper<F32>::fromString(
        _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_Z]->getText());
    _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Z] = z;
    CLAMP<F32>(_currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Z], -360.0f,
               360.0f);
    CEGUI::String zStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_Z]);
...
bool GUIEditor::Handle_RotationGranularityChange(const CEGUI::EventArgs &e) {
    ...
    F32 gran = CEGUI::PropertyHelper<F32>::fromString(
        _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY]->getText());
    _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY] = gran;
    CLAMP<F32>(_currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY],
               0.0000001f, 359.0f);
    CEGUI::String granStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY]);
    _valuesField[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY]->setText(
        granStr);
    return true;
}
...
bool GUIEditor::Handle_ScaleGranularityChange(const CEGUI::EventArgs &e) {
    ...
    F32 gran = CEGUI::PropertyHelper<F32>::fromString(
        _valuesField[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY]->getText());
    _currentValues[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY] = gran;
    CLAMP<F32>(_currentValues[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY],
               0.0000001f, 10000000.0f);
    CEGUI::String granStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY]);
...
bool GUIEditor::Handle_IncrementPositionGranularity(const CEGUI::EventArgs &e) {
    ...
    F32 pos = std::min(
        _currentValues[TRANSFORM_POSITION][CONTROL_FIELD_GRANULARITY] * 10.0f,
        10000000.0f);
...
bool GUIEditor::Handle_IncrementRotationGranularity(const CEGUI::EventArgs &e) {
    ...
    F32 gran = std::min(
        _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY] * 10.0f,
        359.0f);
    _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY] = gran;
    CEGUI::String granStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_ROTATION][CONTROL_FIELD_GRANULARITY]);
...
bool GUIEditor::Handle_IncrementScaleGranularity(const CEGUI::EventArgs &e) {
    ...
    F32 gran = std::min(
        _currentValues[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY] * 10.0f,
        10000000.0f);
    _currentValues[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY] = gran;
    CEGUI::String granStr = CEGUI::PropertyHelper<F32>::toString(
        _currentValues[TRANSFORM_SCALE][CONTROL_FIELD_GRANULARITY]);
