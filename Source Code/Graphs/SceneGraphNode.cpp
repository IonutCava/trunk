...
bool SceneGraphNode::intersect(const Ray& ray, F32 start, F32 end, std::vector<SGNRayResult>& intersections) const {
...
void SceneGraphNode::processDeleteQueue(std::vector<vec_size>& childList) {
