...
public:
    ...
    void create_textureFlat(Format format, unsigned int components, const CTexture &baseImage);
    void create_texture3D(Format format, unsigned int components, const CTexture &baseImage);
    void create_textureCubemap(Format format, unsigned int components, const CTexture &positiveX, const CTexture &negativeX, const CTexture &positiveY,
